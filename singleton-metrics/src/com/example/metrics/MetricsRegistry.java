...
public class MetricsRegistry implements Serializable {
    ...
    private static volatile MetricsRegistry INSTANCE; // BROKEN: not volatile, not thread-safe - FIXED
    private final Map<String, Long> counters = new HashMap<>();

    // BROKEN: should be private and should prevent second construction - FIXED
    ...
    // BROKEN: racy lazy init; two threads can create two instances - FIXED
    ...
    // TODO: implement readResolve() to preserve singleton on deserialization - DONE
    @Serial
